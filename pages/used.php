...
<div class="header-bg">
        ...
        <div class="banner-top">
            <div class="header-bottom">
                 <div class="header_bottom_right_images" style="height: 296px">
                     <div class="about_wrapper"><h1>
        Used Cars By Brand and Model Name
        </h1>
                    </div>
 ...
 <div  id="vll" style="height:auto; width: auto; margin-top: 10%; ">
        ...
        <div class="d11">
        <hr/>
           <caption style=""><h2 style="text-color: #cccccc ">By Price</h2><hr/><p>&nbsp;</p></caption>
           <table>
           <tr><td><input type="radio"  name="g" value="500000 and 800000" onclick="he(this.value); ">500000-1500000</td></tr> 
             <tr><td> <input type="radio" value="810000 and 1000000" onclick="he(this.value);" name="g">1500000-2500000</td></tr>
             <tr><td><input type="radio" value="1100000 and 3000000" onclick="he(this.value);" name="g">2500000-3500000</td></tr>
             <tr><td><input type="radio" value="31000000 and 50000000" onclick="he(this.value);" name="g">3500000-4500000</td></tr>
            </table>
            <p>&nbsp;</p>
            <hr/>
             <caption><h2 style="text-color: #cccccc ">By Fuel Type</h2><hr/><p>&nbsp;</p></caption>
             <table>
             ...
             <table>
                <tr><td><input type="radio" value="Gray" name="g"  onclick="he3(this.value);" title="Select Grey Car Click Here">Gray</td></tr> 
                 ...
                 <tr><td> <input type="radio" value="Silver" name="g" onclick="he33(this.value);" title="Select Black Car Click Here">Silver gray</td></tr>
             ...
             <table>
                <tr><td><input type="radio" value="Hatchback" name="g" title="Select Hatchback Body Type" onclick="he2(this.value);">Hatchback</td></tr> 
                 ...
                 <tr><td><input type="radio" value="Muv" name="g" title="Select Muv Body Type" onclick="he2(this.value);">Muv</td></tr> 
                  <tr><td><input type="radio" value="Super Luxury" name="g" title="Select Super-luxury Body Type" onclick="he2(this.value);">Luxury</td></tr> 
             </table>
